...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		size(850, 600, OPENGL);  // Set up the Applet window to be 800x600
		...
		// The next line zooms in and centers the map att
		...
		//42.07f, -88.06f, location of my town.
		map2 = new UnfoldingMap(this, 450, 50, 350, 500, provider);
//	    map2.zoomAndPanTo(zoomLevel, new Location(42.0752384,-88.0656929));
